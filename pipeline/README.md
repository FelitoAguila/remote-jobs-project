...
I used python, the script ``managed-execution.py`` has all the instructions that Prefect needs. So, I need to run it to create the deployment. 
...
- ``prefect profile use prefect-cloud``: switch to prefect cloud if needed. 
